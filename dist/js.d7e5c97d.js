...
function fetchData(value) {
  fetch("https://api.github.com/users/".concat(value)).then(function (response) {
  ...
  fetch("https://api.github.com/users/".concat(value, "/repos")).then(function (response) {
    return response.json();
  }).then(function (data) {
...
},{}]},{},["../../../../.nvm/versions/node/v9.11.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/js/index.js"], null)
